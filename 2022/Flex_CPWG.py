...
hfss = Hfss(specified_version='2022.1', solution_type="DrivenTerminal")
...
xt = (totla_length - r * radians(theta))/2
...
def create_waveport(face_id, port_num="1", reference_names=[]):
...
for s, port_name in zip(port_faces, ["1", "2"]):
    ...
    print(port_name)
    print(reference)
    create_waveport(s.id, port_name, reference)
